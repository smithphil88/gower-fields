...
Google fonts was used in order to import Poppins and as a back-up font Sans Serif. Poppins was chosen to convey a modern and simple style while being easy to read. A colour scheme was initially chosen from [Coolors](https://coolors.co/). This colour scheme was chosen to convey the mood of the website. The earth coloured tones set the atmosphere of the site as it evokes feelings of being outside in nature. The colours were slightly altered from the original palette due to contrast issues. You can see the final color scheme here - [Coolors](https://coolors.co/5b5656-7f5e3e-d4a373-e9edc9-faedcd-fefae0)
...
![Home page 1](documentation/contact-response.png)
